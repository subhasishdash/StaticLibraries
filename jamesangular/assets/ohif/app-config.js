const ipaddress = origin.replace('3000', '8082');
//const wadoUriRoot = 'http://localhost:8082/pacs/getDicomFile';
const wadoUriRoot = `${origin}/pacs/getDicomFile`;
window.config = {
  // default: '/'
  routerBasename: '/',
  extensions: [],
  ...
  servers: {
    dicomWeb: [
      ...
      }, */
      {
        name: 'TELERADIO',
        wadoUriRoot,
        qidoRoot: ipaddress + '/pacs',
        wadoRoot: ipaddress + '/pacs',
